...
<html>
    ...
    <body>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" href="${pageContext.request.contextPath}/products/1">Products</a>
                  </li>
        ...
        <div style="margin: 4rem">
            <c:if test="${role == 'admin'}">
                <a type="submit" class="btn btn-primary btn-lg"  href="${pageContext.request.contextPath}/products/add">Add a product</a>
            </c:if>
                ...
                <tbody id="tbody-products">
                    <c:forEach items="${products}" var="product">
                        <tr>
                            ...
                            <td>
                                <a type="button" class="" data-bs-toggle="modal" data-bs-target="#modal-image-${product.getId()}">
                                    <img width="150rem" src="${pageContext.request.contextPath}/resources/images/${product.getImgUrl()}" alt="alt"/>
                                </a>
                                <div class="modal fade" id="modal-image-${product.getId()}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="margin-top: 1em">
                                    <div class="modal-dialog modal-fullscreen">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body" style="text-align: center">
                                              <img width="800em" src="${pageContext.request.contextPath}/resources/images/${product.getImgUrl()}"" alt="alt"/>
                                          </div>
                            ...
                            <c:if test="${role == 'admin'}">
                               <td>
                                    <a class="btn btn-primary" href="${pageContext.request.contextPath}/products/edit/id=${product.getId()}">Edit</a>
                                    <a class="btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"
                                        onclick="
                                            ...
                                            idDelete = id
                                            console.log(id)
                                            document.getElementById('modal-delete-confirm').textContent = `Do you want to delete product with #ID is ` + id + '?'
                                        "
                                        >Delete</a>
        ...
        <div style="text-align: center">
            <c:choose>
                <c:when test="${currentPage - 1 >= 1}">
                    <a class="btn btn-primary page-button" href="${pageContext.request.contextPath}/products/${currentPage - 1}"><</a>
                </c:when>
                <c:otherwise>
            ...
            <c:forEach var="page" begin="${currentPage}" end="${firstEndPage}">
                <c:choose>
                    <c:when test="${currentPage==page}">
                        <a class="btn btn-primary" href="${pageContext.request.contextPath}/products/${page}">${page}</a>
                    </c:when>
                    <c:otherwise>
                        <a class="btn btn-primary page-button" href="${pageContext.request.contextPath}/products/${page}">${page}</a>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
                                ...
                                <li class="list-group-item btn" style="margin: 0px; padding: 0px">
                                    ...
                                    <c:choose>
                                        <c:when test="${page == currentPage}">
                                            <a class="btn btn-primary" style="display: block; width: 100%; height: 100%; margin: 0px"  href="${pageContext.request.contextPath}/products/${page}">Page ${page}</a> 
                                        </c:when>
                                        <c:otherwise>
                                            <a class="btn" style="display: block; width: 100%; height: 100%; margin: 0px" href="${pageContext.request.contextPath}/products/${page}">Page ${page}</a> 
                                        </c:otherwise>
                                    </c:choose>
                                </li>
                              </c:forEach>
              ...
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-danger" onclick="
                            ...
                            formDelete.setAttribute('action', '${pageContext.request.contextPath}/products/delete/'      + idDelete)
                            formDelete.submit()
                          ">Delete</button>
                </div>
              </div>
